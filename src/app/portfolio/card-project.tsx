...
const CardProject = ({ button, title, tecnology }: Props) => {
  return (
    <div className="group flex flex-col bg-sky-blue-100 border-[5px] overflow-hidden border-[skyblue] mx-0 sm:mx-[20px] rounded-[.5rem] gap-[0.5rem] sm:gap-[1rem] py-[0.5rem] relative text-center text-lg sm:text-xl">
      <h6 className="font-bold">{title}</h6>
      <div className="w-full overflow-hidden border-[#000] rounded-[3px] border-[1px]">
        <img
          className="w-[250px] sm:w-[350px] h-[165px] sm:h-[230px] object-cover group-hover:scale-105 transition-all duration-300"
          loading="lazy"
          alt={title}
