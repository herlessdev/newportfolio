...
const Portfolio = ({ id, dictionary }: Props) => {
  ...
  const projects = [
    {
      title: "Tauro",
      href: "https://herlessdev.github.io/tauro/",
      tecnology: ["tailwind", "react"],
      category: 1,
    },
    {
      title: "VCI-LLC",
      href: "https://herlessdev.github.io/vci-llc/",
      tecnology: ["tailwind", "react"],
      category: 1,
    },
    {
      title: "Changomon",
      href: "https://herlessdev.github.io/game-simon/",
      tecnology: ["html", "css", "javascript", "react"],
      category: 2,
    },
    {
      title: "Pokemon Emerald",
      href: "https://herlessdev.github.io/newpokemon/",
      tecnology: ["react", "css", "python", "postgresql", "typescript"],
      category: 2,
    },
    {
      title: "Landing-page Web",
      href: "https://herlessdev.github.io/landingpageweb/",
      tecnology: ["react"],
      category: 1,
    },
    {
      title: "Template-home-adidas",
      href: "https://herlessdev.github.io/template-ecommerce/",
      tecnology: ["html", "css", "javascript", "react"],
      category: 1,
    },
    {
    ...
    {
      title: "Fastest Food",
      href: "https://herlessdev.github.io/fastestfood/",
      tecnology: ["html", "css", "javascript", "jquery"],
      category: 1,
    },
    {
      title: "Game of Life",
      href: "https://herlessdev.github.io/gameoflife/",
      tecnology: ["html", "css", "javascript", "react"],
      category: 3,
    },
    {
      title: "Tres raya",
      href: "https://herlessdev.github.io/tresraya/",
      tecnology: ["html", "css", "javascript", "react"],
      category: 2,
    },
    {
      title: "Tetris",
      href: "https://herlessdev.github.io/Tetris/",
      tecnology: ["html", "css", "javascript", "react"],
      category: 2,
    },
    {
